...
var CSSCore = {
  ...
  addClass: function (element, className) {
    'production' !== "production" ? invariant(!/\s/.test(className), 'CSSCore.addClass takes only a single class name. "%s" contains ' + 'multiple classes.', className) : invariant(!/\s/.test(className));
  ...
  removeClass: function (element, className) {
    'production' !== "production" ? invariant(!/\s/.test(className), 'CSSCore.removeClass takes only a single class name. "%s" contains ' + 'multiple classes.', className) : invariant(!/\s/.test(className));
  ...
  hasClass: function (element, className) {
    'production' !== "production" ? invariant(!/\s/.test(className), 'CSS.hasClass takes only a single class name.') : invariant(!/\s/.test(className));
    if (element.classList) {
...
function validateInstanceHandle() {
  ...
  'production' !== "production" ? warning(valid, 'InstanceHandle not injected before use!') : null;
}
...
var EventPluginHub = {
  ...
  putListener: function (id, registrationName, listener) {
    'production' !== "production" ? invariant(typeof listener === 'function', 'Expected %s listener to be a function, instead got type %s', registrationName, typeof listener) : invariant(typeof listener === 'function');
...
var injection = {
  ...
  injectMount: function (InjectedMount) {
    ...
    if ('production' !== "production") {
      'production' !== "production" ? warning(InjectedMount && InjectedMount.getNode && InjectedMount.getID, 'EventPluginUtils.injection.injectMount(...): Injected Mount ' + 'module is missing getNode or getID.') : null;
    }
  }
};
...
if ('production' !== "production") {
  validateEventDispatches = function (event) {
    ...
    'production' !== "production" ? warning(idsIsArr === listenersIsArr && IDsLen === listenersLen, 'EventPluginUtils: Invalid `event`.') : null;
  };
}
...
function accumulateDirectionalDispatches(domID, upwards, event) {
  if ('production' !== "production") {
    'production' !== "production" ? warning(domID, 'Dispatching id must not be null') : null;
  }
...
function _assertSingleLink(inputProps) {
  'production' !== "production" ? invariant(inputProps.checkedLink == null || inputProps.valueLink == null, 'Cannot provide a checkedLink and a valueLink. If you want to use ' + 'checkedLink, you probably don\'t want to use valueLink and vice versa.') : invariant(inputProps.checkedLink == null || inputProps.valueLink == null);
}
function _assertValueLink(inputProps) {
  _assertSingleLink(inputProps);
  'production' !== "production" ? invariant(inputProps.value == null && inputProps.onChange == null, 'Cannot provide a valueLink and a value or onChange event. If you want ' + 'to use value or onChange, you probably don\'t want to use valueLink.') : invariant(inputProps.value == null && inputProps.onChange == null);
}

function _assertCheckedLink(inputProps) {
  _assertSingleLink(inputProps);
  'production' !== "production" ? invariant(inputProps.checked == null && inputProps.onChange == null, 'Cannot provide a checkedLink and a checked property or onChange event. ' + 'If you want to use checked or onChange, you probably don\'t want to ' + 'use checkedLink') : invariant(inputProps.checked == null && inputProps.onChange == null);
}
...
var ReactBrowserComponentMixin = {
   ...
   */
  getDOMNode: function () {
    'production' !== "production" ? warning(this.constructor[didWarnKey], '%s.getDOMNode(...) is deprecated. Please use ' + 'React.findDOMNode(instance) instead.', ReactInstanceMap.get(this).getName() || this.tagName || 'Unknown') : null;
...
if ('production' !== "production") {
  noEventListener = function () {
    'production' !== "production" ? warning(false, 'transition(): tried to perform an animation without ' + 'an animationend or transitionend event after timeout (' + '%sms). You should either disable this ' + 'transition in JS or add a CSS animation/transition.', NO_EVENT_TIMEOUT) : null;
  };
}
...
function instantiateChildIntoContext(traverseContext, child, name) {
  ...
  if (traverseContext[name] !== undefined) {
    if ('production' !== "production") {
      'production' !== "production" ? warning(true, 'instantiateChildren(...): Encountered two children with the same key, ' + '`%s`. Child keys must be unique; when two children share a key, only ' + 'the first child will be used.', name) : null;
    }
    return;
  }
...
},{"133":133,"148":148,"168":168,"170":170,"173":173,"90":90}],36:[function(_dereq_,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
if ('production' !== "production") {
  ...
  if (ExecutionEnvironment.canUseDOM && window.top === window.self) {
    ...
    'production' !== "production" ? warning(!ieCompatibilityMode, 'Internet Explorer is running in compatibility mode; please add the ' + 'following tag to your HTML to prevent this from happening: ' + '<meta http-equiv="X-UA-Compatible" content="IE=edge" />') : null;
...
function assertValidProps(component, props) {
  ...
  if ('production' !== "production") {
    if (voidElementTags[component._tag]) {
      'production' !== "production" ? warning(props.children == null && props.dangerouslySetInnerHTML == null, '%s is a void element tag and must not have `children` or ' + 'use `props.dangerouslySetInnerHTML`.', component._tag) : null;
    }
  }
  ...
  render: function () {
    ...
    ReactChildren.forEach(this.props.children, function (child) {
      ...
      if (typeof child === 'string' || typeof child === 'number') {
        ...
        'production' !== "production" ? warning(false, 'Only strings and numbers are supported as <option> children.') : null;
      }
    });
...
var ReactElementValidator = {
  ...
  createElement: function (type, props, children) {
    ...
    'production' !== "production" ? warning(typeof type === 'string' || typeof type === 'function', 'React.createElement: type should not be null, undefined, boolean, or ' + 'number. It should be a string (for DOM elements) or a ReactClass ' + '(for composite components).%s', getDeclarationErrorAddendum()) : null;
...
var ReactMount = {
  ...
  _registerComponent: function (nextComponent, container) {
    'production' !== "production" ? invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE), '_registerComponent(...): Target container is not a DOM element.') : invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE));
  ...
  renderSubtreeIntoContainer: function (parentComponent, nextElement, container, callback) {
    'production' !== "production" ? invariant(parentComponent != null && parentComponent._reactInternalInstance != null, 'parentComponent must be a valid React Component') : invariant(parentComponent != null && parentComponent._reactInternalInstance != null);
  ...
  unmountComponentAtNode: function (container) {
    ...
    'production' !== "production" ? invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE), 'unmountComponentAtNode(...): Target container is not a DOM element.') : invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE));
  ...
  _mountImageIntoNode: function (markup, container, shouldReuseMarkup) {
    'production' !== "production" ? invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE), 'mountComponentIntoNode(...): Target container is not valid.') : invariant(container && (container.nodeType === ELEMENT_NODE_TYPE || container.nodeType === DOC_NODE_TYPE || container.nodeType === DOCUMENT_FRAGMENT_NODE_TYPE));
...
function cloneWithProps(child, props) {
  if ('production' !== "production") {
    'production' !== "production" ? warning(!child.ref, 'You are calling cloneWithProps() on a child with a ref. This is ' + 'dangerous because you\'re creating a new child which will not be ' + 'added as a ref to its parent.') : null;
  }
...
function invariantArrayCase(value, spec, command) {
  'production' !== "production" ? invariant(Array.isArray(value), 'update(): expected target of %s to be an array; got %s.', command, value) : invariant(Array.isArray(value));
  var specValue = spec[command];
  'production' !== "production" ? invariant(Array.isArray(specValue), 'update(): expected spec of %s to be an array; got %s. ' + 'Did you forget to wrap your parameter in an array?', command, specValue) : invariant(Array.isArray(specValue));
}

function update(value, spec) {
  'production' !== "production" ? invariant(typeof spec === 'object', 'update(): You provided a key path to update() that did not contain one ' + 'of %s. Did you forget to include {%s: ...}?', ALL_COMMANDS_LIST.join(', '), COMMAND_SET) : invariant(typeof spec === 'object');

  if (hasOwnProperty.call(spec, COMMAND_SET)) {
    'production' !== "production" ? invariant(Object.keys(spec).length === 1, 'Cannot have more than one key in an object with %s', COMMAND_SET) : invariant(Object.keys(spec).length === 1);
  ...
  if (hasOwnProperty.call(spec, COMMAND_MERGE)) {
    ...
    'production' !== "production" ? invariant(mergeObj && typeof mergeObj === 'object', 'update(): %s expects a spec of type \'object\'; got %s', COMMAND_MERGE, mergeObj) : invariant(mergeObj && typeof mergeObj === 'object');
    'production' !== "production" ? invariant(nextValue && typeof nextValue === 'object', 'update(): %s expects a target of type \'object\'; got %s', COMMAND_MERGE, nextValue) : invariant(nextValue && typeof nextValue === 'object');
  ...
  if (hasOwnProperty.call(spec, COMMAND_SPLICE)) {
    'production' !== "production" ? invariant(Array.isArray(value), 'Expected %s target to be an array; got %s', COMMAND_SPLICE, value) : invariant(Array.isArray(value));
    'production' !== "production" ? invariant(Array.isArray(spec[COMMAND_SPLICE]), 'update(): expected spec of %s to be an array of arrays; got %s. ' + 'Did you forget to wrap your parameters in an array?', COMMAND_SPLICE, spec[COMMAND_SPLICE]) : invariant(Array.isArray(spec[COMMAND_SPLICE]));
    spec[COMMAND_SPLICE].forEach(function (args) {
      'production' !== "production" ? invariant(Array.isArray(args), 'update(): expected spec of %s to be an array of arrays; got %s. ' + 'Did you forget to wrap your parameters in an array?', COMMAND_SPLICE, spec[COMMAND_SPLICE]) : invariant(Array.isArray(args));
      nextValue.splice.apply(nextValue, args);
    });
  }

  if (hasOwnProperty.call(spec, COMMAND_APPLY)) {
    'production' !== "production" ? invariant(typeof spec[COMMAND_APPLY] === 'function', 'update(): expected spec of %s to be a function; got %s.', COMMAND_APPLY, spec[COMMAND_APPLY]) : invariant(typeof spec[COMMAND_APPLY] === 'function');
  ...
  validateDOMNesting = function (childTag, childInstance, ancestorInfo) {
    ...
    if (problematic) {
      ...
      if (invalidParent) {
        ...
        'production' !== "production" ? warning(false, 'validateDOMNesting(...): <%s> cannot appear as a child of <%s>. ' + 'See %s.%s', childTag, ancestorTag, ownerInfo, info) : null;
      } else {
        'production' !== "production" ? warning(false, 'validateDOMNesting(...): <%s> cannot appear as a descendant of ' + '<%s>. See %s.', childTag, ancestorTag, ownerInfo) : null;
      }
    }
  };
